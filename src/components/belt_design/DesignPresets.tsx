...
export function DesignPresets({ onLoadPreset }: DesignPresetsProps) {
  const presets = [
    ...
    { id: 'Sunset_Elegance', name: 'Sunset Elegance', image: '/assets/belt_design/leather.jpg' },
    { id: 'Ocean_Breeze', name: 'Ocean Breeze' },
    { id: 'Forest_Walk', name: 'Forest Walk' },
    { id: 'Royal_Purple', name: 'Royal Purple' },
    { id: 'Ruby_Gold', name: 'Ruby & Gold' },
    { id: 'Emerald_Ivory', name: 'Emerald & Ivory' },
    { id: 'Grape_Ivory', name: 'Grape & Ivory' },
